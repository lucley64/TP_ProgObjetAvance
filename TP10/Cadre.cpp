...
// gotoXY : positionne le curseur en xy - rep�re cart�sien (0,0) en bas � gauche
...
// gotoXYint : positionne le curseur en xy et �crit i
void Cadre::gotoXY (const Coordonnees xy, const unsigned int i) {
    gotoXY(xy); cout << i;
}

// gotoXYchar : positionne le curseur en xy et �crit c
void Cadre::gotoXY (const Coordonnees xy, char c) {
    gotoXY(xy); cout << c;
}

// gotoXYstring : positionne le curseur en xy et �crit s
